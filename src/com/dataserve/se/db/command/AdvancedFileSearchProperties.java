...
public class AdvancedFileSearchProperties extends CommandBase {
	private static final String REPOSITORY_ID = "repositoryId";

	public AdvancedFileSearchProperties(HttpServletRequest request) {
		super(request);
	}

	public AdvancedFileSearchProperties(PluginServiceCallbacks callbacks, HttpServletRequest request, HttpServletResponse response) {
	...
	public String execute() throws Exception {
		try {
			...
			String searchProperties = request.getParameter("searchProperties");

			Map<String, String> properties = ClassificationModel.fetchCustomClassPropertyDefinitionLocalization(repositoryId, classSymbolicName, searchProperties, callBacks);

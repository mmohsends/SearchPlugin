...
//	private PluginRequestFilter[] pluginRequestFilters = new PluginRequestFilter[0];
	...
	public String getName(Locale locale) {
		if(locale.toString().toLowerCase().startsWith("ar"))
			return "البحث المتقدم فى الملفات";
		else
		return "Advanced File Search Plugin";
	}
	...
	public String getCopyright() {
		return "Optionally add a Copyright statement here now";
	}
	...
	public String getConfigurationDijitClass() {
		return "searchPluginDojo.ConfigurationPane";
	}
	...
	public PluginAction[] getActions() {
		return new com.ibm.ecm.extension.PluginAction[]{ new com.dataserve.se.LinkAction()};
	}
	...
	public com.ibm.ecm.extension.PluginRequestFilter[] getRequestFilters() {
		return new com.ibm.ecm.extension.PluginRequestFilter[]{new com.dataserve.se.services.ContinueQueryService()};
	}
	
	public String getContentClass() {
		return "searchPluginDojo.AdvancedFileSearchFeature";
	}
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[]{
				new com.dataserve.se.services.AdvancedFileSearchService(),
				new com.dataserve.se.services.SearchService(),
				new com.dataserve.se.services.LinkSearchService()
		};
	}
	...
	/**
	    ...
	    public PluginFeature[] getFeatures() {
			return new PluginFeature[]{new AdvancedFileSearchFeature()};
		}
